...
function fromPalette(p: ThemePalette): ColorTheme {
	...
	return {
		...
		machineColors: {
			...
			[MachineType.TNT]:        mc(p.red),
			[MachineType.BUTTON]:     { bg: '#000000', border: p.fg, text: '#ccc' },
		},
		uiBg: p.bg,
		uiBgSurface: p.bg2,
		uiBgElement: p.bg3,
...
function fromLightPalette(p: ThemePalette): ColorTheme {
	...
	return {
		...
		machineColors: {
			...
			[MachineType.TNT]:        mcLight(p.red),
			[MachineType.BUTTON]:     { bg: p.bg, border: p.fg, text: p.fg },
		},
		uiBg: p.bg,
		uiBgSurface: p.bg2,
		uiBgElement: p.bg3,
